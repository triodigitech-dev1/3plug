# Load planning: UI/UX Detailed Spec
...
## Screen Set
- operations/distribution-and-logistics/load-planning/dashboard
- operations/distribution-and-logistics/load-planning/list
- operations/distribution-and-logistics/load-planning/create
- operations/distribution-and-logistics/load-planning/detail/:id
- operations/distribution-and-logistics/load-planning/edit/:id
- operations/distribution-and-logistics/load-planning/approvals
- operations/distribution-and-logistics/load-planning/reports
- operations/distribution-and-logistics/load-planning/analytics
