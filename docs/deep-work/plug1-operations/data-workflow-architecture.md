# Business Operations: Data and Workflow Architecture

## Purpose
Define canonical entities, state machines, and cross-module integration contracts for Business Operations.
