# Leave management (annual, sick, maternity, etc.): UI/UX Detailed Spec
...
## Screen Set
- administration/human-resource-administration/leave-management-annual-sick-maternity-etc/dashboard
