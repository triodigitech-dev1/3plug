...
function Submodule924f33baWorkspace() {
  return (
    <section className="space-y-4">
      ...
      <article className="rounded-xl border border-slate-300/60 bg-white p-4">
        ...
        <pre className="mt-2 overflow-auto text-xs text-slate-600">{JSON.stringify(Submodule924f33baRoutes, null, 2)}</pre>
      </article>
    </section>
  )
}

export { Submodule924f33baRoutes }
export default Submodule924f33baWorkspace
