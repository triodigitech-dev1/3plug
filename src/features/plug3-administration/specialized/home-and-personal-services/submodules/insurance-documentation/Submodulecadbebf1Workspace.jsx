...
function Submodulecadbebf1Workspace() {
  return (
    <section className="space-y-4">
      ...
      <article className="rounded-xl border border-slate-300/60 bg-white p-4">
        ...
        <pre className="mt-2 overflow-auto text-xs text-slate-600">{JSON.stringify(Submodulecadbebf1Routes, null, 2)}</pre>
      </article>
    </section>
  )
}

export { Submodulecadbebf1Routes }
export default Submodulecadbebf1Workspace
